...
**本项目为移动端竖屏服务**（默认画幅 9:20，主输入为触控）。桌面浏览器仅作预览壳。详见 `research/synthesis/mobile-portrait-first.md`。
...
- **界面文案一律中文**：玩家可见的按钮、标签、任务、提示、日志、帮助均为中文；专有名词可保留原文但须有中文主文案（如「霓虹方言 / NOIR」）
